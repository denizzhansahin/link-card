        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none bg-white dark:bg-slate-800/50 p-6 sm:p-10 rounded-xl shadow-xl">
            ...
            */}
            ...
            <p>
              You can also manage your cookie preferences for our Service through any cookie consent banner or tool we may provide. (<em>If you use a cookie consent manager, describe how users can access it.</em>)
            </p>
            <p>
