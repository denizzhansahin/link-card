...
const PrivacyPolicyPage = () => {
  const lastUpdated = "October 26, 2023"; // CHANGE THIS TO THE CURRENT DATE
  const companyName = "Space Teknopoli";
  const appName = "LinkSphere"; // Or your app's actual name
  const supportEmail = "privacy@spaceteknopoli.com"; // CHANGE THIS
  const websiteUrl = "https://www.yourlinkpshereapp.com"; // CHANGE THIS
      ...
      <div className="bg-slate-50 dark:bg-slate-900 py-12 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none bg-white dark:bg-slate-800/50 p-6 sm:p-10 rounded-xl shadow-xl">
            ...
            <p>
              If you wish to exercise any of these rights, please contact us at <a href={`mailto:${supportEmail}`}>{supportEmail}</a>. We may need to verify your identity before responding to such requests. Please note that we may not be able to provide the Service without some necessary data.
            </p>
            <p>
            ...
            <p>
              If you are a California resident, you may have additional rights under the California Consumer Privacy Act (CCPA) / California Privacy Rights Act (CPRA). Please see our (<em>If you have one, link to a CCPA/CPRA Addendum or specific section here</em>).
            </p>
            ...
            <ul>
              ...
              <li>By visiting this page on our website: <Link href="/contact">{websiteUrl}/contact</Link> (<em>Adjust if your contact page URL is different</em>)</li>
